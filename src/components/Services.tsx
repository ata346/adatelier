...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20 bg-brand-light-gray/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div 
              key={index}
              className="group bg-background rounded-2xl p-8 shadow-elegant hover:shadow-glow transition-all duration-300 hover:-translate-y-2"
            >
