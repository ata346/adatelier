...
const Footer = () => {
  ...
  return (
    <footer className="bg-brand-dark-navy text-brand-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="font-brand-body text-brand-white/70 text-sm leading-relaxed">
              Crafting creative solutions for modern advertising. We help brands 
              tell their stories through innovative design and strategic campaigns.
            </p>
          </div>
            ...
            <div className="space-y-2">
              {["About", "Services", "Contact"].map((link) => (
                <a
                  ...
                  className="block font-brand-body text-brand-white/70 hover:text-brand-mid-blue transition-colors duration-300 text-sm"
                >
                  {link}
                </a>
              ))}
